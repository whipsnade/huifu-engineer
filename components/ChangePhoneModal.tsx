    ...
    <div className="absolute inset-0 z-[120] flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-sm bg-white dark:bg-slate-800 rounded-[2rem] p-6 shadow-2xl animate-in zoom-in-95 duration-200">
        ...
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">更换手机号</h2>
          <button 
            onClick={onClose}
        ...
        <div className="space-y-5">
          <div className="space-y-2">
            <label className="text-sm font-bold text-slate-600 dark:text-slate-300">新手机号</label>
            <input 
              type="tel"
              placeholder="请输入新手机号"
              value={newPhone}
          ...
          <button 
            onClick={onSuccess}
            className="w-full bg-[#4f46e5] hover:bg-[#4338ca] text-white font-bold text-[15px] py-4 rounded-2xl mt-8 shadow-[0_8px_20px_-6px_rgba(79,70,229,0.5)] active:scale-[0.98] transition-all"
          >
            确认更换
          </button>
        </div>
